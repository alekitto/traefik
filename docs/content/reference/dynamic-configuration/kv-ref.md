...
| `traefik/http/services/Service04/serverless/AWSAccessKey` | `foobar` |
| `traefik/http/services/Service04/serverless/AWSEndpoint` | `foobar` |
| `traefik/http/services/Service04/serverless/AWSLambdaFunctionArn` | `foobar` |
| `traefik/http/services/Service04/serverless/AWSRegion` | `foobar` |
| `traefik/http/services/Service04/serverless/AWSSecretKey` | `foobar` |
